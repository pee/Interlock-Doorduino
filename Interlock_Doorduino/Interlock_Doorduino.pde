...
#define USE_DHCP
#ifndef USE_DHCP
#define DEF_IP { 10, 10, 1, 43 }
#define DEF_GW { 10, 10, 1, 254 }
#define DEF_SN { 255, 255, 255, 0 }  
#define DEF_DNS { 10, 10, 1, 254 }
#endif
...
#undef DYNAMIC_MAC
#ifndef DYNAMIC_MAC
#define DEF_MAC {  0x0, 0x4, 0xA3, 0x3, 0x8B, 0x2C };
...
static byte ldapServer[4] = { 10,10,1,42 };
static uint16_t serverPort = 65042;
...
void setup() {
  ...
  digitalWrite(strikePin, LOW); //DEBUG explicit low
  delay(5000);
